...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setInstitute(data.data.institute || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setInstitute(data.institute || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.inspections_inspector = await users.getInspections_inspector({
      transaction,
    });
    ...
    output.institute = await users.getInstitute({
      transaction,
    });
