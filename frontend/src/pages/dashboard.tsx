...
const Dashboard = () => {
  ...
  const [inspections, setInspections] = React.useState('Loading...');
  ...
  const [institutes, setInstitutes] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_INSPECTIONS') && (
          ...
          {hasPermission(currentUser, 'READ_INSTITUTES') && (
            <Link href={'/institutes/institutes-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
