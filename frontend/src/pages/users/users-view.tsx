    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Institutes</p>

            <p>{users?.institute?.name ?? 'No data'}</p>
          </div>

          <>
            <p className={'block font-bold mb-2'}>Inspections Inspector</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.inspections_inspector &&
                      Array.isArray(users.inspections_inspector) &&
                      users.inspections_inspector.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.inspections_inspector?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
