...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/institutes/institutesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureInstitutesCols';
...
const TableSampleInstitutes = ({
  ...
  useEffect(() => {
    if (institutesNotify.showNotification) {
      notify(
        institutesNotify.typeNotification,
        institutesNotify.textNotification,
      );
    }
  }, [institutesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/institutes/institutes-view/?id=${id}`);
  };
...
export default TableSampleInstitutes;
