...
const CardUsers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_INSTITUTES');
              ...
              >
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    ...
                    onEdit={onEdit}
                    itemId={item.id}
                    pathEdit={`/institutes/institutes-edit/?id=${item.id}`}
                    pathView={`/institutes/institutes-view/?id=${item.id}`}
